...
public class Status_Activity extends AppCompatActivity implements OnChartValueSelectedListener {
    private RelativeLayout Back;
    private int companya, companyb, companyc, companyd;
    private TextView toolbar_title;
    private RelativeLayout back, more_details;
    Activity CURRENT_ACTIVITY = Status_Activity.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        more_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CURRENT_ACTIVITY, MoreDetails_Activty.class));
            }
        });
    }
    ...
    private void Initialize() {
        ...
        more_details = (RelativeLayout) findViewById(R.id.more_details);
    }
